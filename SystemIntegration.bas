Attribute VB_Name = "SystemIntegration"
' ====================================================================
...
On Error Resume Next
    ...
    With scriptSheet.Range("B1:I1")
        ...
        .Interior.Color = RGB(0, 66, 37) ' Dark green
...
On Error Resume Next
    ...
    Select Case currentScriptView
        Case VIEW_INITIAL
            ' Initial script - knowledge assessment
            scriptText = "Hi " & activeCustomerName & ", my name is " & Application.userName & "How Are you today?" & vbCrLf & vbCrLf & _
                         "just a reminder that our calls are recorded for training purposes."
                         "I understand you are calling about a novated lease... Is that right?"  & vbCrLf & vbCrLf & _
                         "Have you ever had a novated lease before?"
        ...
        Case VIEW_NOT_MUCH
            ...
            scriptText = "That's perfectly fine - many people are new to novated leasing. Let me explain how it works and what benefits you will get:" & vbCrLf & vbCrLf & _
                         "A novated lease is essentially a three-way agreement between you, your employer, and a finance company. It's a way to pay for a car and its running costs using a combination of your pre-tax and post-tax salary." & vbCrLf & vbCrLf & _
                         "The main benefit is tax savings, as part of your car payments come from your pre-tax salary, reducing your taxable income."  & vbCrLf & vbCrLf & _
        ...
        Case VIEW_A_LITTLE
            ...
            scriptText = "Great, Given you have some familiarity with novated leasing. I'll give you a quick overview, incase something has changed, or you might not have been aware of:" & vbCrLf & vbCrLf & _
                         "A novated lease is essentially a three-way agreement between you, your employer, and a finance company. It's a way to pay for a car and its running costs using a combination of your pre-tax and post-tax salary." & vbCrLf & vbCrLf & _
                         "The main benefit is tax savings, as part of your car payments come from your pre-tax salary, reducing your taxable income."
        ...
        Case VIEW_WELL_EDUCATED
            ...
            scriptText = "Excellent! Since you're already familiar with novated leasing, let's just focus on a quick overview, incase anything has changed since last time." & vbCrLf & vbCrLf & _
                         "A novated lease is essentially a three-way agreement between you, your employer, and a finance company. It's a way to pay for a car and its running costs using a combination of your pre-tax and post-tax salary." & vbCrLf & vbCrLf & _
                         "The main benefit is tax savings, as part of your car payments come from your pre-tax salary, reducing your taxable income." & vbCrLf & vbCrLf & _
